  ...
  return <Box className={classes.component}>
    <Box className={classes.container}>
      ...
      {isAuthenticate ? <>
        ...
        <Button variant="contained" className={classes.btn} color="primary" onClick={() => window.location.replace("/")} style={{
          background: "#222",
        ...
        <br />
        <Button variant="contained" className={classes.btn} color="primary" onClick={() => window.location.replace("/login")} style={{
          background: "#222",
          textTransform: "capitalize"
        }}>
          Login
